...
document.getElementById("head").innerHTML= array[random].name
document.getElementById("itemdescriptiion").innerHTML= array[random].description
document.getElementById("img").innerHTML =`<img id="img" class="w-100 object-fit-cover h-100 rounded-start-4 " src="${array[random].imgCover}" alt="">`
document.getElementById("prep").innerHTML= array[random].prepTime
document.getElementById("cook").innerHTML= array[random].cookTime
document.getElementById("people").innerHTML= array[random].servings
document.getElementById("diff").innerHTML=array[random].difficulty
document.getElementById("type").innerHTML=array[random].category
document.getElementById("rating").innerHTML=array[random].ratingsAverage
document.getElementById("rev").innerHTML=array[random].ratingsQuantity
document.getElementById("calories").innerHTML=array[random].nutrition.calories
document.getElementById("protein").innerHTML=array[random].nutrition.protein
document.getElementById("carb").innerHTML=array[random].nutrition.carbs
document.getElementById("fats").innerHTML=array[random].nutrition.fat
document.getElementById("fiber").innerHTML=array[random].nutrition.fiber
document.getElementById("sodium").innerHTML=array[random].nutrition.sodium




if(array[random].totalTime> 45){
    document.getElementById("extend").innerHTML=`  <div class="bg-danger-subtle  border-4 border-start border-danger p-1 rounded-3 d-flex gap-2 align-items-center ">
      <div class="ms-2 fs-5 text-danger"><i class="fa-solid fa-triangle-exclamation"></i></div>
      <div class=" pt-3"><h2 class="fw-semibold fs-6">Extended Preparation Time</h2>
      <p class="text-danger">This recipe requires more than 45 minutes to prepare. Plan accordingly!</p>
...
for(var i = 0 ; i < array[random].ingredients.length ; i++){
ingred  +=`  <div class="d-flex gap-2 mb-3">
      <div class="text-white rounded-5  d-flex justify-content-center align-items-center arrangment  "> ${i+1}</div>
      <div class="text-gray-700">${array[random].ingredients[i]}</div>
     </div> `
...
var inst = ''
for(var j = 0 ; j< array[random].instructions.length ; j++){
inst += `  <div class="d-flex gap-2 mb-3 align-items-center"> 
        <div class="arang-inst text-white rounded-4  d-flex justify-content-center align-items-center  ">${j+1}</div>
        <div class="text-gray-700">
${array[random].instructions[j]}</div>
      </div>`
...
var tip = ''
for(var k=0 ; k < array[random].tips.length ; k++ ){
tip +=`<div class="p-4 rounded-3 mb-2   "> 
<span class="text-white check rounded-5 me-2"><i class="fa-solid fa-check"></i></span> <span>${array[random].tips[k]}</span>
</div>`
}
document.getElementById('chef').innerHTML=tip
